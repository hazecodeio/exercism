...
public class FlattenerTest {
    ...
    public FlattenerTest(Flattener.StrategyE strategy) {
        this.flattener = new Flattener(strategy);
    }

    @Parameters(name = "Strategy -> {0}")
    public static EnumSet<Flattener.StrategyE> getEnums() {
        return EnumSet.allOf(Flattener.StrategyE.class);
    }
