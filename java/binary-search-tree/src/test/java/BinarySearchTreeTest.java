...
public class BinarySearchTreeTest {
    ...
    public void insertsLess() {
        ...
        char actualRoot = root.getValue();
        char actualLeft = left.getValue();
    ...
    public void insertsSame() {
        ...
        String actualRoot = root.getValue();
        String actualLeft = left.getValue();
        assertEquals(expectedLeft, actualLeft);
        assertEquals(expectedRoot, actualRoot);
    }
    ...
    public void insertsRight() {
        ...
        int actualRoot = root.getValue();
        int actualRight = right.getValue();
